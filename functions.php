...
function my_assets()
{
	...
	$style_version = "1.0.111";
	$scrypt_version = "1.0.111";
	...
	wp_enqueue_script( 'filter', get_template_directory_uri(). '/js/filter.js', array(), $scrypt_version, true); 
...
function wp_corenavi() {
  ...
  if ( $total > 1 ) echo '<nav class="pagination d-flex">';
