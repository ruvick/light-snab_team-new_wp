			...
			<form class="footer__form" action="#">
				<div class="form__line">
					...
					<input id="name" autocomplete="off" type="text" name="form[]" data-error="Заполните поля" data-value="Имя*"
						class="footer__form-input input _req">
					...
					<input id="tel2" autocomplete="off" type="text" name="form[]" data-error="Заполните поля" data-value="E-mail*"
						class="footer__form-input input _email _req">
